<?php 
	...
	if ($n_surat != null) {
		...
		$query = "INSERT INTO tb_surat VALUES (null,'$Tipe','$nomor', '$judul', '$tanggal', '$perihal', '$tujuan', '$namafilebaru', 'keluar')";
		$data = mysqli_query($conn, $query);
		echo "<script>alert('Surat Berhasil ditambah');history.go(-1);</script>";
	}
